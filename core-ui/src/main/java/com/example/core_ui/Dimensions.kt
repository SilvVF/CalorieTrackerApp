...
//data holding class that can provide values to all the modules that inherit
//from the core ui module
//core ui module created to allow the use of composable classes without
//having every module have access to the unneeded compose dependencies
